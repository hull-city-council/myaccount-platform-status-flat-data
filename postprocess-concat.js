...
const filename = Deno.args[0] // Same name as downloaded_filename `const filename = 'myaccount-platform-status-1.json';`
...
await removeFile('./myaccount-platform-status-1.json')
